                  ...
                  <div class="iq-masonry-block">
                     ...
                     <div class="iq-masonry iq-columns-3">
                        ...
                        <div class="iq-masonry-item {{$pengaduan->status}}">
                           <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="false" data-items="1" data-items-laptop="1" data-items-tab="1" data-items-mobile="1" data-items-mobile-sm="1" data-margin="10">
                              @php
                                 $foto = App\Models\Pengaduan_image::where('pengaduan_unique_id', $pengaduan->unique_id)->get();
                              @endphp
                              @foreach($foto as $item)
                                 <div class="item">
                                    <div class="iq-blog-box">
                                       <div class="iq-blog-image clearfix">
                                          <img src="{{ asset('images/'.$pengaduan->foto) }}/{{$item->foto}}" class="img-fluid center-block" alt="blogimage0">
                                          <ul class="iq-blogtag">
                                             <li>
                                       ...
                                       <div class="iq-blog-detail">
                                          ...
                                          <a class="btn-link" href="#">Lihat Tanggapan<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                       </div>
                                    </div>
                                 </div>
                              @endforeach
